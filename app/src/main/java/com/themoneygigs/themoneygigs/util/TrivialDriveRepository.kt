package com.themoneygigs.themoneygigs.util
...
/*        const val SKU_PREMIUM = "premium"
        ...
        const val SKU_TMG_TEST = "tmg_premium_test\n"
        val TAG = TrivialDriveRepository::class.simpleName

        //        val INAPP_SKUS = emptyArray<String>()
        val SUBSCRIPTION_SKUS = arrayOf(
            SKU_INFINITE_GAS_MONTHLY,
            SKU_INFINITE_GAS_YEARLY, SKU_TMG_TEST

        )
//        val AUTO_CONSUME_SKUS =
        //        <String>()//arrayOf(SKU_GAS)
    }
